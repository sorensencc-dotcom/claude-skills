...
description: "1 marketing (top-level) skills — landing-page generator agent skill and Antigravity plugin for single-file HTML output with 4 design styles. Works with Claude Code, Codex CLI, Gemini CLI, and OpenClaw."
---
